...
fun ChestScreen(navController: NavController, index: Int) {
    ...
    var originalTime by remember { mutableStateOf(ChestExerciseList[index].time.toLong() * 1000) }
...
//            ) {
            ...
            LazyColumn(
                ...
                item {
                    val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(ChestExerciseList[index].animation))
