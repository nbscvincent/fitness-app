...
@Composable
fun ShoulderScreen(navController: NavController, index: Int) {

//    var originalTime by remember { mutableStateOf(ShoulderExerciseList[index].time.toLong() * 1000) }
...
//                    ) {
//                    Text(
//                        ShoulderExerciseList[index].title,
