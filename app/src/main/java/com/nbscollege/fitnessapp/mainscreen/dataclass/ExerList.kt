...
val AbsExerciseList = listOf(
    ...
    ExerList(title = "RUSSIAN TWIST", R.raw.russian, time = 90,route = CategoryRoute.ABS.name),
    ExerList(title = "BURPEES", R.raw.burpee, time = 60,route = CategoryRoute.ABS.name),
    ExerList(title = "LEG RAISES", R.raw.leg, time = 90,route = CategoryRoute.ABS.name),
