...
val AbsExerciseList = listOf(
    ...
    ExerList(title = "ABDOMINAL CRUNCHES", R.raw.abdominal, time = 10,route = CategoryRoute.ABS.name),
    ExerList(title = "RUSSIAN TWIST", R.raw.russian, time = 10,route = CategoryRoute.ABS.name),
    ExerList(title = "BURPEES", R.raw.burpee, time = 10,route = CategoryRoute.ABS.name),
    ExerList(title = "LEG RAISES", R.raw.leg, time = 10,route = CategoryRoute.ABS.name),
    ExerList(title = "SQUATS", R.raw.squats, time = 10,route = CategoryRoute.ABS.name),
