...
class BottomAppBarViewModel : ViewModel() {
    var selectedButton by mutableStateOf(SelectedButton.Home)
}
@Composable
fun BottomAppBar(navController: NavController, viewModel: BottomAppBarViewModel){
    var selectedButton by remember { viewModel.selectedButton }
    ...
    BottomAppBar {
                    Row(
                        ...
                        Button(
                            onClick = {
                                selectedButton = SelectedButton.Profile
                            ...
                            Icon(
                                ...
                                tint = if (selectedButton == SelectedButton.Profile) Color.Blue else Color.Black,
                                modifier = Modifier.size(40.dp),
                            )
                        }
